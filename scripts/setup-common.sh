...
function install_faiss {
  if [[ $BUILD_FAISS == "true" ]]; then
    ...
    cmake_install_dir faiss \
      ...
      -DFAISS_ENABLE_BENCHMARKS=OFF -DCMAKE_CXX_FLAGS="-Xpreprocessor -fopenmp -I/usr/lib/llvm-11/lib/clang/11.0.1/include" \
      -DOpenMP_CXX_LIB_NAMES="omp" \
      -DOpenMP_CXX_FLAGS="-Xpreprocessor -fopenmp -I/usr/lib/llvm-11/lib/clang/11.0.1/include" \
