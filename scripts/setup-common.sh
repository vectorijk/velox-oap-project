...
function install_folly {
  ...
  cmake_install_dir folly -DBUILD_SHARED_LIBS="$VELOX_BUILD_SHARED" -DBUILD_TESTS=OFF -DFOLLY_HAVE_INT128_T=ON -DCMAKE_CXX_FLAGS="-fpermissive"
}
...
function install_fizz {
  ...
  cmake_install_dir fizz/fizz -DBUILD_TESTS=OFF "-DCMAKE_CXX_FLAGS=-mavx2 -mfma -mavx -mf16c -mlzcnt -mbmi2 -DFOLLY_CFG_NO_COROUTINES -march=native"
}
